...
# MGS Convert Xsec Stacked to Traditional
...
cross section systems and converts the feature class to the traditional 
...
if run_location == "Pro":
    ...
    out_vertical_exaggeration = int(arcpy.GetParameterAsText(5)) #vertical exaggeration of output feature class
